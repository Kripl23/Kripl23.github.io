...
const DICT = {
  ru: {
    ...
    mineMenuGame: 'Игра',
    mineNew: 'Новая игра',
    mineBeginner: 'Новичок',
    mineIntermediate: 'Любитель',
    mineExpert: 'Профессионал',
    mineFlagMode: 'Ставить флажки',
    mineDigMode: 'Открывать клетки',
    mineHelp: 'Правила',
    mineHelpText: 'Открывайте клетки и не попадите на мину. Цифра показывает, сколько мин соприкасается с клеткой. Правая кнопка ставит флажок. Щелчок по открытой цифре, вокруг которой уже стоят все флажки, открывает соседние клетки.',
  ...
  en: {
    ...
    mineMenuGame: 'Game',
    mineNew: 'New game',
    mineBeginner: 'Beginner',
    mineIntermediate: 'Intermediate',
    mineExpert: 'Expert',
    mineFlagMode: 'Place flags',
    mineDigMode: 'Open cells',
    mineHelp: 'How to play',
    mineHelpText: 'Open cells without hitting a mine. A number tells you how many mines touch that cell. Right-click places a flag. Clicking an open number that already has all its flags around it opens the neighbouring cells.',
    winverTitle: 'About',
  ...
  ja: {
    ...
    mineDigMode: 'マスを開く',
    mineHelp: '遊び方',
    mineHelpText: '地雷を避けてマスを開きます。数字はそのマスに接する地雷の数です。右クリックで旗を立てられます。周囲の旗がすべて揃った数字をクリックすると、隣接するマスが開きます。',
    winverTitle: 'バージョン情報',
